...
docker container run --name hello-world-fast-api-v2 -v $(pwd):/apps -it -p 5000:5000 ambiente-oficina-fastapi-teste-software
...
docker container rm -f hello-world-fast-api-v2
