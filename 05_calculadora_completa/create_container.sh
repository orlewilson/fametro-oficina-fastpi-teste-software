...
docker container run --name calculadora-completa -v $(pwd):/apps -it -p 5000:5000 ambiente-oficina-fastapi-teste-software
...
docker container rm -f calculadora-completa
